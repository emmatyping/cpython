...
static PyObject *
_zstd_EndlessZstdDecompressor_decompress(PyObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    #if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
skip_optional_pos:
    return_value = _zstd_EndlessZstdDecompressor_decompress_impl((ZstdDecompressor *)self, &data, max_length);
