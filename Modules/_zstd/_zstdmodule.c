            ...
            PyObject *fp, ZSTD_outBuffer *out)
{
    ...
    /* Write */
    write_ret = PyObject_CallMethodOneArg(fp, state->str_write, mv);
    Py_DECREF(mv);
...
/*[clinic end generated code: output=6d4228f0e7d8160e input=7de6473668d29d09]*/
{
    ...
    while (1) {
        ...
        temp = PyObject_CallMethodOneArg(input_stream,
...
static PyMethodDef _zstd_methods[] = {
    ...
    _ZSTD_DECOMPRESS_STREAM_METHODDEF
